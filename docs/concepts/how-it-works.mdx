...
```mermaid
%%{init: {'theme':'base','flowchart':{'curve':'step'},'themeVariables':{'fontFamily':'Inter, ui-sans-serif, system-ui, -apple-system, sans-serif','fontSize':'14px','primaryColor':'#1f1f1f','primaryTextColor':'#ebebeb','primaryBorderColor':'#e5a00d','lineColor':'#8a8a8a','clusterBkg':'#141414','clusterBorder':'#2a2a2a','titleColor':'#e5a00d','edgeLabelBackground':'#0e0e0e'}}}%%
flowchart TD
