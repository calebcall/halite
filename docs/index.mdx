...
Halite is a self-hosted web console that manages a SaltStack deployment end-to-end from one UI — covering minion status, key management, job dispatch, package inventory, fleet health, and user access control, all in a single browser tab.
...
<Frame caption="Halite dashboard overview">
  <img src="/images/index-dashboard.png" alt="Halite dashboard showing KPIs, minion-status donut, 24-hour job-activity chart, and key-status bar" />
</Frame>
