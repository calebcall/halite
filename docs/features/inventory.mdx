...
<Frame caption="Inventory package list showing fleet-wide package aggregate with version and minion counts">
  <img src="/images/inventory-packages-v2.png" alt="Table of packages with name, minion count, version count, and last-seen timestamp" />
</Frame>
...
<Frame caption="Per-package version list sorted by minion count descending">
  <img src="/images/inventory-versions-v2.png" alt="Version drill-down showing version string, architecture, source, and minion count" />
</Frame>
