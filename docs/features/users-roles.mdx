...
<Frame caption="User list showing username, display name, active status, and last login">
  <img src="/images/users-list-v2.png" alt="Table of Halite users with username, display name, email, active badge, and last login timestamp" />
</Frame>
...
<Frame caption="Role editor showing role name, description, and permission list">
  <img src="/images/users-role-editor-v2.png" alt="Role detail panel with name, is_builtin badge, and a table of verb/resource_glob permission rows" />
</Frame>
