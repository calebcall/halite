...
<Frame caption="Jobs list showing recent jobs with status badges, function names, and targets">
  <img src="/images/jobs-list.png" alt="Table of recent Salt jobs with JID, function, target, user, and status columns" />
</Frame>
...
<Frame caption="Job detail panel showing per-minion results and highstate state table">
  <img src="/images/jobs-detail.png" alt="Job detail view with per-minion result rows and highstate parsing" />
</Frame>
