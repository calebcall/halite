...
<Frame caption="Fleet health heatmap showing per-minion health status badges">
  <img src="/images/fleet-health.png" alt="Grid of minion health badges colored by status: healthy, changed, unhealthy, blocked, stale, or unknown" />
</Frame>
...
<Frame caption="Compliance chart showing pass/fail/change trend over the last 30 highstate runs">
  <img src="/images/fleet-compliance.png" alt="Stacked bar chart of fleet-wide highstate compliance over time" />
</Frame>
