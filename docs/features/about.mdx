...
<Frame caption="Halite About page showing the brand mark, name origin, and color palette">
  <img src="/images/about-colophon.png" alt="The Halite About page with the lattice brand mark, NaCl mineral fact card, three mark families, and amber color swatches" />
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card title="The Salt Cube" icon="cube">
